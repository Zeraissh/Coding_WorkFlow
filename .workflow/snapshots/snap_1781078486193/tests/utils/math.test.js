...
import { add, subtract, multiply, divide, safeDivide, modulo, sum, average, median, min, max, clamp, round, isEven, isOdd, factorial, power, sqrt, degToRad, radToDeg, lerp, gcd, lcm, } from "../../src/utils/math.js";
// ---------------------------------------------------------------------------
// add
// ---------------------------------------------------------------------------
describe("add", () => {
...
describe("factorial", () => {
    ...
    it("throws for non-integer numbers", () => {
        expect(() => factorial(2.5)).toThrow("Factorial is only defined for non-negative integers.");
